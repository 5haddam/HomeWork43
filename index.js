...
class ProductDescription {
  ...
  attachEventHandlers() {
    this.buyButton.addEventListener('click', () => new DataForm(this.buyButton));
  }
  renderProduct() {
...
class DataForm {
  ...
  attachEventHandlers() {
    this.submitButton.addEventListener('click', (e) => {
      new Modal(this.inputName.value, this.citySelector.value, this.inputPostOfficeNumber.value, this.paymentMethod.value, this.inputProductQuantity.value, this.inputComment.value);
    })
  }
  city() {
